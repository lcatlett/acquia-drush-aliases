...
[![Travis CI](https://travis-ci.org/lcatlett/acquia-drush-aliases.svg?branch=master)](https://travis-ci.org/lcatlett/acquia-drush-aliases)
[![Windows CI](https://ci.appveyor.com/api/projects/status/{{PUT_APPVEYOR_STATUS_BADGE_ID_HERE}}?svg=true)](https://ci.appveyor.com/project/lcatlett/acquia-drush-aliases)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/lcatlett/acquia-drush-aliases/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/lcatlett/acquia-drush-aliases/?branch=master)
[![Coverage Status](https://coveralls.io/repos/github/lcatlett/acquia-drush-aliases/badge.svg?branch=master)](https://coveralls.io/github/lcatlett/acquia-drush-aliases?branch=master) 
...
[![License](https://poser.pugx.org/lcatlett/acquia-drush-aliases/license)](https://github.com/lcatlett/acquia-drush-aliases//master/LICENSE)
-->
...
| Feature                   | Setup
| ------------------------- | ----------------
| Collaborative repository  | [DONE](https://github.com/lcatlett/acquia-drush-aliases)
| Linux permutation testing | [DONE](https://travis-ci.org/lcatlett/acquia-drush-aliases)
...
deploy:
  ...
  on:
    tags: true
    repo: lcatlett/acquia-drush-aliases
```
...
- [GitHub issue templates](https://github.com/lcatlett/acquia-drush-aliases/issues/templates/edit)
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [releases](https://github.com/lcatlett/acquia-drush-aliases/releases) page.

## Authors

* **lcatlett** - created project from template.

See also the list of [contributors](https://github.com/lcatlett/acquia-drush-aliases/contributors) who participated in this project.
